...
Strategy.prototype.userProfile = function(accessToken, done) {
  console.log(this.serverURL + '/user?access_token=' + accessToken);
  this._oauth2.get(this.serverURL + '/user?access_token=' + accessToken, accessToken, function (err, body, res) {
    if (err) { 
